...
- Every action in the workflow is pinned to a commit SHA with the release in a comment. Dependabot's monthly `github-actions` lane raises the bumps (`.github/dependabot.yml`); a bump the repository cannot take is closed with a comment ignore.
